...
use App\Http\Controllers\ProjectFactController;
...
Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
    ...
    Route::post('/workspaces/{workspace}/customers/{customer}/deployments/{deployment}/knowledge-documents/{knowledge_document}/extract-facts', [ProjectFactController::class, 'extract'])->scopeBindings();
    Route::get('/workspaces/{workspace}/customers/{customer}/deployments/{deployment}/project-fact-extractions/{project_fact_extraction}', [ProjectFactController::class, 'showExtraction'])->scopeBindings();
    Route::get('/workspaces/{workspace}/customers/{customer}/deployments/{deployment}/project-facts', [ProjectFactController::class, 'index'])->scopeBindings();
    Route::post('/workspaces/{workspace}/customers/{customer}/deployments/{deployment}/project-facts', [ProjectFactController::class, 'store'])->scopeBindings();
    Route::post('/workspaces/{workspace}/customers/{customer}/deployments/{deployment}/project-facts/bulk-verify', [ProjectFactController::class, 'bulkVerify'])->scopeBindings();
    Route::post('/workspaces/{workspace}/customers/{customer}/deployments/{deployment}/project-facts/bulk-reject', [ProjectFactController::class, 'bulkReject'])->scopeBindings();
    Route::get('/workspaces/{workspace}/customers/{customer}/deployments/{deployment}/project-facts/{project_fact}', [ProjectFactController::class, 'show'])->scopeBindings();
